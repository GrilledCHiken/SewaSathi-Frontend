// Shared icon set for the marketing pages. Kept as inline <path> fragments
// because the project has no icon library installed on purpose.
const ICONS = {
  furniture: (
    <path
      strokeLinecap="round"
  ...
  wallet: (
    <path
      ...
      strokeLinejoin="round"
      strokeWidth={1.75}
      d="M3 10h18M3 10a2 2 0 012-2h14a2 2 0 012 2M3 10v8a2 2 0 002 2h14a2 2 0 002-2v-8m-4 4h.01"
    />
  ),
  clock: (
    <path
