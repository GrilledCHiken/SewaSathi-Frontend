 ...
 *
 * The retry loop is load-bearing: every public page but Home is lazy (see App.jsx), so on a
 * first visit the hash target does not exist yet when this effect runs — the Suspense
 * fallback is still on screen.
 */
